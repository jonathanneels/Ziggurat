		...
		var beatJsonData={};
		        var loadSampleSet ;
        var selectElement ;
        var getSetFormValues ;
        var adsrGainNode ;
        var simpleTracker  ;
 
        var getSetControls  ;
        var getSetAudioOptions ;
        ...
        var storage;
		var initializeSampleSet; 
var schedule;

var masterVolume;

	function setEntireRowPlay(id)
				{
					
 
 var index=0;
						$("#row_"+id.toString()).find('td').each (function() {
							if(index >0){
 this.classList.add("tracker-enabled");}
 index+=1;
...
masterVolume.gain.value = 0.2
    ...
    7: [function(require, module, exports) {
        ...
        "audio-buffer-instrument": 2,
        "get-json-promise": 4,
        "tiny-sample-loader": 8
    }],
    ...
    13: [function(require, module, exports) {
          loadSampleSet = require('load-sample-set');
          selectElement = require('select-element');
          getSetFormValues = require('get-set-form-values');
          adsrGainNode = require('adsr-gain-node');
          simpleTracker = require('./simple-tracker');
        const FileSaver = require('file-saver');

          getSetControls = require('./get-set-controls');
          getSetAudioOptions = new getSetControls();

          defaultTrack =  require('./default-track');

          buffers;
          currentSampleData;
          storage;

     initializeSampleSet =   function (ctx, dataUrl, track) {
            ...
            sampleSetPromise.then(function(data) {
                ...
                if (!track.settings.measureLength) {
                    track.settings.measureLength = 8;
                }
...
*/
    ...
    14: [function(require, module, exports) {
        module.exports = {
            ...
            settings: {
                sampleSet: "DRUMS/sampled.instrument.json",
                measureLength: 8,
                bpm: 460,
                detune: 0,
                gainEnabled: "gain",
    ...
    17: [function(require, module, exports) {
        function trackerTable() {
            ...
            this.setHeader = function(numRows, data) {
                ...
                this.str += this.getCells('header', numRows, {
                    header: true
                });
                this.str += `</tr>`;
            ...
            this.setRows = function(numRows, numCols, data) {
                ...
                for (let rowID = 0; rowID < numRows; rowID++) {
                    this.str += `<tr class="tracker-row" data-id="${rowID}" id="row_${rowID}">`;
            ...
            this.getFirstCell = function(rowID, data) {
                ...
                str += `<td onclick="setEntireRowPlay(${rowID});" class="tracker-first-cell" data-row-id="${rowID}" >`;
                if (data.title) {
